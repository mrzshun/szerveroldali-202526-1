...
@section('content')
    <div class="container">
        ...
        @guest
            <div class="alert alert-danger">Csak bejelentkezett felhasználó hozhat létre posztot!</div>
        @endguest
        ...
        @enderror
                        ...
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input @error('categories.*') is-invalid @enderror"
                                value="{{ $category->id }}" id="category-{{ $category->id }}" @checked(in_array($category->id, old('categories', [])))
                                name=categories[]>
                            {{-- TODO --}}
