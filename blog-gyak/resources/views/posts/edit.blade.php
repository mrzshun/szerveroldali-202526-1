    ...
    <div class="container">
        ...
        --}}
            ...
            <div class="form-group row mb-3">
                ...
                <div class="col-sm-10">
                    <textarea rows="5" class="form-control @error('text') is-invalid @enderror" id="text" name="text">{{old('text',$post->text)}}
                    </textarea>
                    @error('text')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div id="cover_preview" class="col-12">
                                ...
                                <img id="cover_preview_image" src="{{ asset('images/default_post_cover.jpg') }}"
                                    alt="Cover preview">
                            </div>
                        </div>
                    </div>
